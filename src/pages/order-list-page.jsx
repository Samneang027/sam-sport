    ...
    <div>
        ...
        <section className="mt-16 p-4 md:p-8 lg:p-12">
          ...
          <div className='flex border-2 border-primary mt-4'>
            ...
            <input className='pt-4 pr-2 pb-4 pl-4 font-bold text-right text-md md:text-2xl lg:text-4xl text-title ' type="text" readOnly value={"$140.00"} />
          </div>
        </section>
        <section>
          <h1 className='p-4 text-title font-bold text-md md:text-2xl lg:text-4xl text-center'>INFORMATION SHIPPING</h1>
          <div className='p-2 md:p-4'>
            <label for="first_name" className="block mb-2 text-md md:text-lg lg:text-2xl font-medium text-gray-900 dark:text-white">Username</label>
            <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-md md:text-lg lg:text-2xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="SAM Sport" required />
          </div>
          <div className='p-2 md:p-4'>
            <label for="first_name" className="block mb-2 text-md md:text-lg lg:text-2xl font-medium text-gray-900 dark:text-white">Telephone</label>
            <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-md md:text-lg lg:text-2xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="+885 1234567" required />
          </div>
          <div className='p-2 md:p-4'>
            <label for="first_name" className="block mb-2 text-md md:text-lg lg:text-2xl font-medium text-gray-900 dark:text-white">Gmail</label>
            <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-md md:text-lg lg:text-2xl rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="samsport@gmail.com" required />
          </div>
          <div className='p-2 md:p-4'>
            <label for="first_name" className="block mb-2 text-md md:text-lg lg:text-2xl font-medium text-gray-900 dark:text-white">Location</label>
