        ...
        <div>
            ...
            <section className="p-4 md:p-8 lg:p-12 container mx-auto">
                ...
                <div className="pt-8 md:pt-16 lg:pt-24">
                    <CardShop imageSrc={nikelandscape} title="nikelandscape" linkTo="/user-dashboard/nike"/>
                    <CardShop imageSrc={pumalandscape} title="pumalandscape" linkTo="/user-dashboard/puma"/>
                    <CardShop imageSrc={adidaslandscape} title="adidaslandscape" linkTo="/user-dashboard/adidas"/>
                </div>
            </section>
