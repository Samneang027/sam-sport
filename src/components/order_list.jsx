        ...
        <div className="p-4 flex border-1 border-secondary justify-between container mx-auto">
            <div className="items-center flex">
                <div className="bg-secondary hover:bg-gray w-20 h-20 md:w-40 md:h-40 flex items-center justify-center">
                    <img src={(Array.isArray(content.images) && content.images[0]) || content.thumbnail} alt="content.name" className="max-w-full max-h-full" />
                </div>
            </div>
            <div className="pl-2 md:w-90 lg:w-150">
                ...
                <div className="flex justify-between bg-secondary p-1 md:p-3 lg:p-4 rounded-full">
                    <FontAwesomeIcon icon={faCircleMinus} className="text-red-500 text-2xl md:text-3xl lg:text-4xl cursor-pointer hover:text-red-700" onClick={() => updateQuantity(content.cartItemUuid, -1)}/>
                    <input type="number" className="w-20 text-center md:text-lg lg:text-2xl" value={content.quantity || 1}/>
                    <FontAwesomeIcon icon={faCirclePlus} className="text-green-500 text-2xl md:text-3xl lg:text-4xl cursor-pointer hover:text-green-700" onClick={() => updateQuantity(content.cartItemUuid, 1)}/>
                </div>
            </div>
            <div className="w-50 text-center">
                ...
                <button onClick={() => removeFromCart(content.cartItemUuid)} className="block pt-15 md:pt-27 lg:pt-30"><FontAwesomeIcon icon={faTrash} className="ml-10 text-red-500 text-2xl md:text-3xl lg:text-4xl cursor-pointer hover:text-red-700" /></button>
            </div>
        </div>
    );
